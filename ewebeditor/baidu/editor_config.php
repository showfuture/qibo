...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"<?php echo "$webdb[www_url]/$webdb[updir]/other/";?>"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,filePath:"<?php echo "$webdb[www_url]/$webdb[updir]/other/";?>"                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        ,catchRemoteImageEnable:false               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"php/getRemoteImage.php"   //处理远程图片抓取的地址
        ,catcherPath:"<?php echo "$webdb[www_url]/$webdb[updir]/other/";?>"                  //图片修正地址，同imagePath
        ...
        //屏幕截图配置区
        ,snapscreenHost: '<?php echo $HOST;?>'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: "<?php echo $PATH;?>/ewebeditor/baidu/php/imageUp.php" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
