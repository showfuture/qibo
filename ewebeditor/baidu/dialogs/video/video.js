...
(function(){
        ...
        (function(){
            ...
            if(img && img.className == "edui-faked-video"){
				...
				for (var i=0;i<objt.options.length;i++ ){
					if(objt.options[i].value==img.vtype)objt.options[i].selected = true;
				}
    ...
    function createPreviewVideo(url){
        ...
        }else if(!endWith(url,[".swf",".flv",".wmv",".mid",".mp3",".mp4",".wma",".wav",".asf",".aac",".flac",".ape",".avi",".avi",".asf",".asx",".wmv",".mpg",".mpeg",".ra",".rm",".rmvb",".ram"])){
