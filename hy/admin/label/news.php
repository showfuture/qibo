...
if($action=='mod'){
	...
	$url2='$webdb[www_url]/home/?uid=$uid&m=newsview&id=$id';
	...
	$SQL="SELECT * FROM {$_pre}news $SQL ORDER BY $order $asc LIMIT $sqlmin,$rows ";
	...
	$getLabelTpl=getLabelTpl('info',array("common_title"));

	require("head.php");
	require(dirname(__FILE__)."/../template/label/news.htm");
	require("foot.php");
