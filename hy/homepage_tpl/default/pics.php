...
print <<<EOT
--> 
<link rel="stylesheet" type="text/css" href="$Murl/images/default/pic.css">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rightinfo">
  <tr>
    <td  class="head">
	<span class='L'></span>
	<span class='T'><a href="?uid=$uid&m=pics">公司图库</a></span>
	<span class='R'></span>
	<span class='more'>&nbsp;
<!--
EOT;
...
function ShowThisPic(thisPic){
	...
	$(".showMainPic table").css("height",PicH+"px");
			...
			<div class="showMainPic">				
				...
				<li class="up"><table><tr><td><img src="$Murl/images/default/3.gif"/></td></tr></table></li>
				<li class="down"><table><tr><td><img src="$Murl/images/default/2.gif"/></td></tr></table></li>
			</div>
<!--
EOT;
}
